...
const TopicItem:React.FC<ITopicProps> = ({infomation}) => {
  return (
    <div style={{display:'flex', flexDirection:'column', width:'200px', borderRadius:'16px', borderColor:'gray', borderWidth:'6px', alignItems:'center', borderStyle:'solid', marginLeft:'1rem', marginRight:'1rem'}}>
